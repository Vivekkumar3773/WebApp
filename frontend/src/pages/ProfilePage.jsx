                ...
                <div className='bg-base-300 rounded-xl p-6 space-y-8'>
                    ...
                    <div className='flex flex-col items-center gap-4'>
                        <div className='relative'>
                            <img src={selectedImage || authUser.profilePic || "/avatar.png"} alt="profile Pic" className='size-32 rounded-full object-cover border-4' />
                        ...
                        <p className='text-sm text-zinc-400'>
                            {isUpdatingProfile ? "Uploading..." : "Click the Camera icon to update your photo or avatar"}
                        </p>
                    </div>
